#!/usr/bin/env node
/**
 * Generates the INTRO+LOOP Lottie for "live-onboarding-companion-z6ke.svg" —
 ...
 * Output: public/projects/live-onboarding-companion-z6ke/scene-1/lottie.json
 *
...
const OUT_DIR = join(__dirname, '../public/projects/live-onboarding-companion-z6ke/scene-1')
...
// ── Raw path data lifted from live-onboarding-companion-z6ke.svg (viewBox 0 0 240 240) ──
const SVG_PATHS = {
