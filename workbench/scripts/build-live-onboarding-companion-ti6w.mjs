#!/usr/bin/env node
/**
 * Generates the INTRO+LOOP Lottie for "live-onboarding-companion-ti6w.svg" —
 ...
 *    rest, pulls in at true peak contraction.
 ...
 * reach that follows it. See docs/live-onboarding-companion-ti6w-animation.md
 * for the measurement.
 ...
 *
 * Output: public/projects/live-onboarding-companion-ti6w/scene-1/lottie.json
 */
...
const OUT_DIR = join(__dirname, '../public/projects/live-onboarding-companion-ti6w/scene-1')
...
const SVG_SRC = readFileSync(join(__dirname, '../assets/live-onboarding-companion-ti6w.svg'), 'utf8')
function tagById(id) {
  const needle = `id="${id}"`
