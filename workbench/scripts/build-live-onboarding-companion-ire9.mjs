#!/usr/bin/env node
/**
 * Generates the INTRO+LOOP Lottie for "live-onboarding-companion-ire9.svg" —
 ...
 * Output: public/projects/live-onboarding-companion-ire9/scene-1/lottie.json
 *
...
const OUT_DIR = join(__dirname, '../public/projects/live-onboarding-companion-ire9/scene-1')
