#!/usr/bin/env node
/**
 * Generates a seamlessly-looping Lottie JSON for "loop-zenek-our-fmj2.svg"
 ...
 *  loop-zenek-our-wn6g scenes; the source SVG's path data is byte-identical
 *  — verified all 17 animated paths via the intake id→d diff — so this
 *  reuses that proven, documented rig verbatim.
 *  See docs/dataprocessing-loop-animation.md for the full rationale.)
 * Output: public/projects/loop-zenek-our-fmj2/scene-1/lottie.json
 *
...
const OUT_DIR = join(__dirname, '../public/projects/loop-zenek-our-fmj2/scene-1')
...
const doc = {
  v: '5.9.0', fr: FPS, ip: 0, op: T, w: W, h: H, nm: 'Loop Zenek — Our (fmj2)',
  ddd: 0,
