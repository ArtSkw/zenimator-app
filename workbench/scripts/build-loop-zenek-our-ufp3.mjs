#!/usr/bin/env node
/**
 * Generates a seamlessly-looping Lottie JSON for "loop-zenek-our-ufp3.svg"
 ...
 * Output: public/projects/loop-zenek-our-ufp3/scene-1/lottie.json
 *
...
const OUT_DIR = join(__dirname, '../public/projects/loop-zenek-our-ufp3/scene-1')
...
const doc = {
  v: '5.9.0', fr: FPS, ip: 0, op: T, w: W, h: H, nm: 'Loop Zenek — Our (ufp3)',
  ddd: 0,
