#!/usr/bin/env node
/**
 * Generates the INTRO+LOOP Lottie for "live-onboarding-companion-lcjz.svg" —
 ...
 *    — see docs/live-onboarding-companion-lcjz-animation.md's
 ...
 * reach that follows it. See docs/live-onboarding-companion-lcjz-animation.md
 * for the measurement.
 ...
 *
 * Output: public/projects/live-onboarding-companion-lcjz/scene-1/lottie.json
 */
...
const OUT_DIR = join(__dirname, '../public/projects/live-onboarding-companion-lcjz/scene-1')
...
// CLOCK_TRAIL_SMALL=48) — see docs/live-onboarding-companion-lcjz-animation.md.
...
const SVG_SRC = readFileSync(join(__dirname, '../assets/live-onboarding-companion-lcjz.svg'), 'utf8')
function tagById(id) {
  const needle = `id="${id}"`
