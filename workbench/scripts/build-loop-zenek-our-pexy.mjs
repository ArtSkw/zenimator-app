#!/usr/bin/env node
/**
 * Generates a seamlessly-looping Lottie JSON for "loop-zenek-our-pexy.svg"
 ...
 *  loop-zenek-our-wn6g / loop-zenek-our-ufp3 / loop-zenek-our-gq92 /
 *  loop-zenek-our-kwze scenes; the source SVG is byte-identical (md5
 *  93f891bc40cb275f234aaf7f65731441) — so this reuses that proven,
 *  documented rig verbatim.
 *  See docs/dataprocessing-loop-animation.md for the full rationale.)
 * Output: public/projects/loop-zenek-our-pexy/scene-1/lottie.json
 *
...
const OUT_DIR = join(__dirname, '../public/projects/loop-zenek-our-pexy/scene-1')
...
const doc = {
  v: '5.9.0', fr: FPS, ip: 0, op: T, w: W, h: H, nm: 'Loop Zenek — Our (pexy)',
  ddd: 0,
