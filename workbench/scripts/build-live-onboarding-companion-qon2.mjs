#!/usr/bin/env node
/**
 * Generates the INTRO+LOOP Lottie for "live-onboarding-companion-qon2.svg" —
 ...
 * Output: public/projects/live-onboarding-companion-qon2/scene-1/lottie.json
 *
 ...
 * See docs/live-onboarding-companion-qon2-animation.md for the mood retune
...
const OUT_DIR = join(__dirname, '../public/projects/live-onboarding-companion-qon2/scene-1')
...
// companion-qon2.svg): plate rect x=14 y=14 w=176 h=35 (bottom edge y=49);
