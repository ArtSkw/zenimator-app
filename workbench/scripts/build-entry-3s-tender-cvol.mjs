#!/usr/bin/env node
/**
 * Generates the Lottie JSON for entry-3s-tender-cvol — a phone (face,
 * band-aid, dots) resting on a pillow, breathing gently while a green ribbon
 * hand-draws itself around it. Source: assets/entry-3s-tender-cvol.svg.
 *
...
const SVG_FILE = join(__dirname, '../assets/entry-3s-tender-cvol.svg')
const OUT_DIR = join(__dirname, '../public/projects/entry-3s-tender-cvol/scene-1')
