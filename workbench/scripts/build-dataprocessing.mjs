#!/usr/bin/env node
/**
 * Generates a seamlessly-looping Lottie JSON for "DataProcessing problem.svg"
 * — Zenek perched on his badge, gears turning, pen jotting notes.
 * Output: public/projects/dataprocessing/scene-1/lottie.json
 *
...
const OUT_DIR = join(__dirname, '../public/projects/dataprocessing/scene-1')
...
const doc = {
  v: '5.9.0', fr: FPS, ip: 0, op: T, w: W, h: H, nm: 'DataProcessing Loop',
  ddd: 0,
