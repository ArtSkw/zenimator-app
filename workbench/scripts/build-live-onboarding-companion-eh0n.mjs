#!/usr/bin/env node
/**
 * Generates the INTRO+LOOP Lottie for "live-onboarding-companion-eh0n.svg" —
 ...
 * scripts/build-live-onboarding-companion-ire9.mjs, which is now the
 * reference build (velocity-audit fix: the whole drink gesture is now driven
 * by continuous waypointCurve envelopes, no more travel-balanced or sparse
 * pose-to-pose keyframes — see the DRINK CLUSTER section below and
 * docs/live-onboarding-companion-eh0n-animation.md's port note for what
 * changed and why); see that same doc for the full rig writeup.
 * Output: public/projects/live-onboarding-companion-eh0n/scene-1/lottie.json
 *
 ...
 * See docs/live-onboarding-companion-eh0n-animation.md for the mood retune
...
const OUT_DIR = join(__dirname, '../public/projects/live-onboarding-companion-eh0n/scene-1')
...
// companion-eh0n.svg — pixel-identical to -ire9.svg, same numbers): plate
// rect x=14 y=14 w=176 h=35 (bottom edge y=49);
