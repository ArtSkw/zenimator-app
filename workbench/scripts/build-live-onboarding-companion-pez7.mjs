#!/usr/bin/env node
/**
 * Generates the INTRO+LOOP Lottie for "live-onboarding-companion-pez7.svg" —
 ...
 *    — see docs/live-onboarding-companion-pez7-animation.md's
 ...
 * reach that follows it. See docs/live-onboarding-companion-pez7-animation.md
 * for the measurement.
 ...
 *
 * Output: public/projects/live-onboarding-companion-pez7/scene-1/lottie.json
 */
...
const OUT_DIR = join(__dirname, '../public/projects/live-onboarding-companion-pez7/scene-1')
...
const SVG_SRC = readFileSync(join(__dirname, '../assets/live-onboarding-companion-pez7.svg'), 'utf8')
function tagById(id) {
  const needle = `id="${id}"`
...
const QUIVER_LO = 5, QUIVER_HI = 35 // local-cycle frames (t % IDLE), centered on t=20 — true peak contraction, NOT the absolute-time T=54 loop marker
...
trailCircle('trail-small', 132, 92.5, TRAIL_SMALL_SRC.r, [{ t: 0, v: 0, ease: 'entranceSharp' }, { t: 8, v: 112, ease: 'settleSoft' }, { t: 16, v: 100 }], CLOCK_TRAIL_SMALL, 0.9, -1)
trailCircle('trail-large', 120, 79, TRAIL_LARGE_SRC.r, [{ t: 4, v: 0, ease: 'entranceSharp' }, { t: 14, v: 114, ease: 'settleSoft' }, { t: 22, v: 100 }], CLOCK_TRAIL_LARGE, 1.1, 1)
