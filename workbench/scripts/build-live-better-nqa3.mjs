#!/usr/bin/env node
/**
 * Generates the Lottie JSON for live-better-nqa3 — "live. better." handwritten
 * entrance. Source: assets/live-better-nqa3.svg (20 filled brush-stroke paths,
...
const SVG_FILE = join(__dirname, '../assets/live-better-nqa3.svg')
const OUT_DIR = join(__dirname, '../public/projects/live-better-nqa3/scene-1')
