#!/usr/bin/env node
/**
 * Generates the INTRO+LOOP Lottie for "live-onboarding-companion-wg4l.svg" —
 ...
 * Output: public/projects/live-onboarding-companion-wg4l/scene-1/lottie.json
 *
 ...
 * See docs/live-onboarding-companion-wg4l-animation.md for the mood retune
...
const OUT_DIR = join(__dirname, '../public/projects/live-onboarding-companion-wg4l/scene-1')
...
// companion-wg4l.svg): plate rect x=14 y=14 w=176 h=35 (bottom edge y=49);
