#!/usr/bin/env node
/**
 * Builds public/projects/live-better-k7ur/scene-1/lottie.json from the
...
const SVG_PATH = join(__dirname, '../assets/live-better-k7ur.svg')
const OUT_DIR = join(__dirname, '../public/projects/live-better-k7ur/scene-1')
