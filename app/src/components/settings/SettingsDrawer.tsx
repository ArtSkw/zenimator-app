...
export function SettingsDrawer() {
  const { model, effort, agentUrl, agentToken, setModel, setEffort, setAgentUrl, setAgentToken } = useSettingsStore()
    ...
    <Sheet open={open} onOpenChange={handleOpenChange}>
      ...
      <SheetContent className="flex flex-col gap-0 sm:max-w-[440px]">
        <SheetHeader className="border-b border-border">
          ...
          <SheetDescription>
            Engine, model, and appearance for this browser.
          </SheetDescription>
        </SheetHeader>
