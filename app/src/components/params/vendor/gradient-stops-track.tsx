// Vendored from toolcraft (MIT, Pixel Point) — the gradient-stops machinery.
// Imports rewritten to this folder; behaviour untouched, so upstream fixes
// stay diffable. Full notice: ../LICENSE-toolcraft.md
"use client";

import type * as React from "react";

import { selectedItemBorderClassName } from "./selection-state";
